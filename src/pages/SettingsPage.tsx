    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-4 pb-6 space-y-6">
        ...
        <section className="space-y-2">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full flex items-center gap-3 p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-sm font-medium"
            >
          ...
          <section className="space-y-2">
            ...
            <div className="p-4 rounded-2xl bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 space-y-2">
              ...
              <p className="text-xs text-blue-600 dark:text-blue-400">
                In Safari, tap the Share icon → scroll down → tap <strong>Add to Home Screen</strong> for the best experience.
              </p>
            </div>
          </section>
        )}
        ...
        <section className="space-y-2">
          ...
          <button
            onClick={handleWipe}
            className="w-full flex items-center gap-3 p-4 rounded-2xl bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 text-sm font-medium text-red-600 dark:text-red-400"
          >
